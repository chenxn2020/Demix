...
class ConvE(Model):
    """ConvE: the model of knowledge graph embedding.

    This model is the implementation of a paper that is
    Convolutional 2D Knowledge Graph Embedding.

    Attributes:
        args: Some pre-set parameters related to this model,
            such as the number of entities and relations.
        emb_ent: The embedding of entitise, the first dimension
            is equal to the number of entities, the second dimension
            is equal to the number of embedding dimensions.
        emb_rel: The embedding of relations, the first dimension
            is equal to the number of relations, the second dimension
            is equal to the number of embedding dimensions.
    """
    ...
    def init_emb(self,args):
        # Instantiation of entity and relation embedding
    ...
    def get_score(self, batch, mode=None):
