...
class KGBCEDataModule(BaseDataModule):
    """
    Base DataModule.
    ...
    def train_dataloader(self):
        ...
        if self.args.loss_name == "Cross_Entropy_Loss":
            return DataLoader(
                ...
                pin_memory=True,
                drop_last=True,
                collate_fn=self.train_sampler.sampling_with_label,
            )
        elif self.args.loss_name == "BCE_Loss" or self.args.loss_name == "Adv_Bce_Loss":
            return DataLoader(
                self.data_train,
                shuffle=True,
                batch_size=self.train_bs,
